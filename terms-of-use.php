...
function require_tou_front_end($content){
    ...
    if (!isset($tou_settings['frontend_page']) || $tou_settings['frontend_page'] == '' || $tou_settings['frontend_page'] != $post->ID || 
...
function set_tou_defaults(){
    ...
    $tou_data = array('member_agreement' => $member_agreement, 'terms' => $terms, 'privacy_policy' => $privacy_policy, 'welcome' => $welcome, 'site_name' => $tou_name, 'agree' => $agree, 'cleared_on' => current_time('mysql', 1), 'show_date' => 0, 'initials' => false, 'signup_page' => false, 'comment_form' => false, 'admin_page' => 'index.php', 'frontend_page' => '', 'terms_page' => '', 'menu_page' => 'index.php');
