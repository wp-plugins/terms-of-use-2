<?php
  ...
  // if the settings were changed save them
	if($_POST and isset($_POST['terms'])){
	    $tou_data = array('member_agreement' => $_POST['member_agreement'], 'terms' => $_POST['terms'], 'privacy_policy' => $_POST['privacy_policy'], 'welcome' => $_POST['welcome'], 'site_name' => $_POST['site_name'], 'agree' => $_POST['agree'], 'show_date' => $_POST['show_date'], 'initials' => $_POST['initials'], 'signup_page' => $_POST['signup_page']);
